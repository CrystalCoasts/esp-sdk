...
void DHT2::setDHTgpio( gpio_num_t gpio )
{
	DHTgpio = gpio;
}
...
float DHT2::getHumidity() { return humidity; }
float DHT2::getTemperature() { return temperature; }

// == error handler ===============================================

void DHT2::errorHandler(int response)
{
	switch(response) {
...
int DHT2::getSignalLevel( int usTimeOut, bool state )
{
